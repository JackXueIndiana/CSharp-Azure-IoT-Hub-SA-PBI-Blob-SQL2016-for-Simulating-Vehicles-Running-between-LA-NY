...
namespace CreateDeviceIdentity
{
    class Program
    {
        ...
        static string connectionString = "HostName=jackiot.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=";
        ...
        private static async Task AddDeviceAsync()
        {
            for (int i = 0; i <1; i++)
            {
                ...
                StreamWriter sw = new StreamWriter("C:\\Users\\xinxue\\Desktop\\Customer\\TelemetryDeviceIdKey1.txt", true);
